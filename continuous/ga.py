...
def genetic_algorithm(fitness_function, dims, bound, population_size=100, iterations=60, mutation_rate=0.05, crossover_rate=0.7, callback=None):
    ...
    for generation in range(iterations):
        ...
        if callback and not callback(-best_fitness, generation):
            break
